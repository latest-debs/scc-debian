...
[![Release](https://img.shields.io/github/v/release/latest-debs/scc-debian)](https://github.com/latest-debs/scc-debian/releases)
[![Build](https://github.com/latest-debs/scc-debian/actions/workflows/release.yml/badge.svg)](../../actions)
...
```sh
sudo apt install ./scc_*.deb
```

## Verify

```sh
apt-cache policy scc
scc --version
```
...
Run the [Build scc for Debian](../../actions) workflow on GitHub with the
